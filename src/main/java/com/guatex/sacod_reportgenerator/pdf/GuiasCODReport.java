...
public class GuiasCODReport extends Pdf_Utils {
	...
	public GuiasCODReport(String nombreArchivo) throws FileNotFoundException, DocumentException, Exception {
		try {
	...
	public PdfPTable getResumen(Tabla tbl, int width) throws Exception {
		float widths[] = { 1.5f, 0.3f, 0.8f, 0.3f, 0.8f, 0.3f, 0.8f, 1.2f };
